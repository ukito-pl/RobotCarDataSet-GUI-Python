...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressBar1 = QtGui.QProgressBar(self.centralwidget)
        self.progressBar1.setProperty("value", 0)
        self.progressBar1.setObjectName(_fromUtf8("progressBar1"))
        self.gridLayout.addWidget(self.progressBar1, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.imageView, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pointcloudArea, 3, 0, 1, 1)
