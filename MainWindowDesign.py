...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pointcloudButton.setText(_translate("MainWindow", "Build and draw sample pointcloud", None))
