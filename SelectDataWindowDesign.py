...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        QtCore.QObject.connect(self.pointToImageBoxCustom, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.startTimeImgCustom.setDisabled)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_61.setToolTip(_translate("Dialog", "<html><head/><body><p>Czas pierwszego zdjęcia do wyswietlenia, relatywny względem czasu startu. W przypadku nakładania punktów 3d na obraz jest on równy 0.</p></body></html>", None))
        self.label_61.setText(_translate("Dialog", "Czas pierwszego zdjęcia [ms]:", None))
        self.startTimeImgCustom.setToolTip(_translate("Dialog", "<html><head/><body><p>Czas pierwszego zdjęcia do wyswietlenia, relatywny względem czasu startu. W przypadku nakładania punktów 3d na obraz jest on równy 0.</p></body></html>", None))
