...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.startTimeImg.setToolTip(_translate("Dialog", "<html><head/><body><p>Czas pierwszego zdjęcia do wyswietlenia, relatywny względem czasu pierwszego pomiaru z lidaru. </p></body></html>", None))
        self.label_17.setToolTip(_translate("Dialog", "Czas pierwszego zdjęcia do wyswietlenia, relatywny względem czasu pierwszego pomiaru z lidaru. ", None))
        self.label_17.setText(_translate("Dialog", "Czas pierwszego zdjęcia [ms]:", None))
        self.label_18.setToolTip(_translate("Dialog", "Czas ostatniego zdjęcia do wyswietlenia, relatywny względem czasu pierwszego pomiaru z lidaru. ", None))
        self.label_18.setText(_translate("Dialog", "Czas ostatniego zdjęcia [ms]:", None))
        self.endTimeImg.setToolTip(_translate("Dialog", "<html><head/><body><p>Czas ostatniego zdjęcia do wyswietlenia, relatywny względem czasu pierwszego pomiaru z lidaru. </p></body></html>", None))
